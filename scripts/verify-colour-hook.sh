...
expect_allowed \
  "design-system-token" \
  "{\"hook_event_name\":\"PreToolUse\",\"tool_name\":\"Write\",\"tool_input\":{\"file_path\":\"$repo_root/core/designsystem/src/main/kotlin/hook/Palette.kt\",\"content\":\"val token = Color(0xFF112233)\"}}"
...
printf 'Colour-hook protocol checks passed: 2 blocked, 3 allowed\n'
