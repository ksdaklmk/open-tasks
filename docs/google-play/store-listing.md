...
|---|---|---|
| Embedded SDKs | Release runtime contains AndroidX, Kotlin, Room/SQLCipher, Tink/Bouncy Castle, Hilt and `com.google.android.gms:play-services-auth:21.6.0`; no Firebase, analytics, telemetry, advertising, billing or crash-reporting SDK match | PASS — repository dependency audit; PASS — final AAB audit (ledger entry 2026-09-03T13:01:03Z, candidate `019db088…cb885`) |
| Network | Production application origins found are Google Drive (`https://www.googleapis.com`) and the fixed privacy URL opened in an external browser; no developer-operated application backend was found | PASS — repository source audit; PASS — final AAB audit (ledger entry 2026-09-03T13:01:03Z, candidate `019db088…cb885`) |
